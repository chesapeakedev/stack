...
/**
 * Drawer component root. Manages the open/closed state of the drawer.
 * Built on top of Vaul for smooth interactions and animations.
 *
 * @example
 * ```tsx
 * <Drawer>
...
/**
 * Trigger element that opens/closes the drawer.
 *
 * @example
 * ```tsx
 * <DrawerTrigger asChild>
 ...
 * Supports multiple directions: top, bottom, left, right (default: bottom).
 *
 * @example
 * ```tsx
