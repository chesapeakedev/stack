 ...
 * Manages the open/closed state and selected value.
 *
 * @example
 * ```tsx
 * <Select>
 ...
 * Used with SelectLabel to create labeled groups.
 *
 * @example
 * ```tsx
 * <SelectContent>
 ...
 * Contains the SelectValue and dropdown arrow.
 *
 * @example
 * ```tsx
 ...
 * Displays when the select is open.
 *
 * @example
 * ```tsx
 * <SelectContent>
...
/**
 * Scroll up button displayed when content overflows.
 */
...
/**
 * Scroll down button displayed when content overflows.
 */
